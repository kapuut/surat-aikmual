                        ...
                        <>
                          ...
                          <a
                            href={refId < 0
                              ...
                              : /\.(html|htm|xhtml)$/i.test(surat.file_path || '')
                                ? `${surat.file_path}?print=1`
                                : /\.(doc|docx)$/i.test(surat.file_path || '')
                                  ? `/api/files/docx-print?path=${encodeURIComponent(surat.file_path || '')}`
                                  : surat.file_path || '#'}
                            target="_blank"
