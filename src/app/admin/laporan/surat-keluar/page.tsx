...
export default function LaporanSuratKeluarPage() {
  ...
  const [suratKeluar] = useState([
    {
      noRegistrasi: "REG-OUT-001/2025",
      noSurat: "003/DESA/2025",
      tanggalSurat: "2025-10-01",
      pengirim: "Kepala Desa Aikmual",
      perihal: "Laporan Kegiatan Bulan September",
      penerima: "Camat Aikmual"
    },
    {
      noRegistrasi: "REG-OUT-002/2025",
      noSurat: "004/DESA/2025", 
      tanggalSurat: "2025-10-03",
      pengirim: "Sekretaris Desa",
      perihal: "Undangan Rapat Desa",
      penerima: "BPD Aikmual"
    },
    {
      noRegistrasi: "REG-OUT-003/2025",
      noSurat: "005/DESA/2025",
      tanggalSurat: "2025-10-07",
      pengirim: "Kepala Desa Aikmual",
      perihal: "Permohonan Bantuan Sosial",
      penerima: "Dinas Sosial NTB"
    },
    {
      noRegistrasi: "REG-OUT-004/2025",
      noSurat: "006/DESA/2025",
      tanggalSurat: "2025-10-09",
      pengirim: "Kepala Desa Aikmual",
      perihal: "Surat Keterangan Domisili",
      penerima: "Ahmad Yusuf"
    },
    {
      noRegistrasi: "REG-OUT-005/2025",
      noSurat: "007/DESA/2025",
      tanggalSurat: "2025-10-11",
      pengirim: "Sekretaris Desa",
      perihal: "Undangan Musyawarah Desa",
      penerima: "Seluruh Warga Desa"
    }
  ]);
          ...
          <div className="bg-white rounded-lg border border-gray-200 shadow-sm p-4">
            <div className="flex items-center justify-between">
              ...
              <div className="bg-red-100 p-2 rounded-full">
                <span className="inline-block w-10 h-10 bg-green-100 text-green-700 rounded-full flex items-center justify-center text-xs font-bold">OUT</span>
              </div>
            </div>
          </div>
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-2xl font-bold text-purple-600">
                  {suratKeluar.filter(s => new Date(s.tanggalSurat).getMonth() === new Date().getMonth()).length}
                </p>
              </div>
