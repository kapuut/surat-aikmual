...
export default function SuratJandaInfoPage() {
  ...
  const prosedur = [
    ...
    },
    {
      ...
      desc: "Lengkapi data diri dan informasi status janda/duda",
    },
    {
      step: 3,
        ...
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="bg-white rounded-lg shadow-lg p-8 mb-8">
            <div className="flex items-center mb-6">
              <FiFileText className="text-pink-500 text-3xl mr-3" />
            ...
            <div className="space-y-6">
              {prosedur.map((item) => (
                <div key={item.step} className="flex items-start">
                  <div className="flex-shrink-0 w-10 h-10 bg-pink-500 rounded-full flex items-center justify-center text-white font-bold mr-4">
                    {item.step}
                  </div>
                  <div>
          ...
          <div className="text-center">
            <button
              onClick={() => router.push("/permohonan/surat-janda/form")}
              className="bg-pink-500 hover:bg-pink-600 text-white font-bold py-4 px-8 rounded-lg text-lg transition duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
            >
