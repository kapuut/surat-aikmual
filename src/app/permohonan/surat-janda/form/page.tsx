        ...
        <form onSubmit={handleSubmit} onInvalidCapture={handleInvalid} className="space-y-6">
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <textarea
              ...
              required
              rows={3}
              placeholder="Contoh: Persyaratan administrasi bantuan sosial"
          ...
          <div className="flex justify-end gap-3">
            <Link href="/" className="bg-gray-100 text-gray-700 text-sm py-2.5 px-5 rounded-lg font-semibold hover:bg-gray-200 transition-colors text-center">
              Batal
            </Link>
