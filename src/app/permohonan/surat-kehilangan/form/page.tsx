...
export default function SuratKehilanganPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    formData.set("provinsi", asTitleCase("provinsi"));
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="max-w-4xl mx-auto px-4">
        ...
        <form onSubmit={handleSubmit} onInvalidCapture={handleInvalid} className="space-y-6">
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            <h2 className="text-lg font-semibold text-gray-900 mb-2">Masa Berlaku</h2>
            <p className="text-sm text-gray-600">Masa berlaku surat diatur otomatis selama 6 bulan sejak tanggal terbit surat.</p>
          </div>
          ...
          <div className="bg-white rounded-lg shadow-sm p-6">
            ...
            <textarea
              ...
              required
              rows={3}
              placeholder="Contoh: Persyaratan pengurusan dokumen pengganti"
              className="w-full px-4 py-2 border border-gray-300 rounded-lg bg-white focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
            />
          </div>
          ...
          <div className="flex justify-end gap-3">
            <Link href="/permohonan/surat-kehilangan" className="bg-gray-100 text-gray-700 text-sm py-2.5 px-5 rounded-lg font-semibold hover:bg-gray-200 transition-colors text-center">
              Batal
            </Link>
