...
import { FiUsers, FiFileText, FiCheckCircle, FiArrowLeft } from "react-icons/fi";
import Header from "@/components/layout/Header";
import FooterWrapper from "@/components/layout/FooterWrapper";
import { OFFICIAL_STANDARD_PROCEDURE } from "@/lib/template-surat/official-defaults";

export default function SuratCeraiInfoPage() {
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-white pt-20">
        <div className="max-w-4xl mx-auto px-4 py-12">
          ...
          <div className="text-center">
            <button
              onClick={() => router.push("/permohonan/surat-cerai/form")}
              className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-4 px-8 rounded-lg text-lg transition duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1"
            >
